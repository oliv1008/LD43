...
func _ready():
	...
	tie.buff_text("A group of yellow vest from Paris stop your car.\n", 0.03)
	tie.buff_silence(0.5)
	tie.buff_text("What do you do ?\n\n\n\n")
	tie.buff_silence(0.5)
	tie.buff_text("1 : You keep driving, but take the risk to hurt someone\n")
	tie.buff_silence(0.5)
	tie.buff_text("2 : You scream : MACRON DEMISSION !\n")
	tie.buff_silence(0.5)
	tie.buff_text("3 : You ask who the leader of the movement is and ask to 1v1 him\n")
	tie.buff_silence(0.5)
	tie.buff_text("4 (Anarchist) : You go out of the car and demonstrate with them\n ")
	tie.buff_silence(0.5)
