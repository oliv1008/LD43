...
func _ready():
	...
	tie.buff_silence(0.5)
	tie.buff_text("1 : Ask for another card\n")
	tie.buff_silence(0.5)
	tie.buff_text("2 : You don't ask for another card\n")
	tie.buff_silence(0.5)
	tie.buff_text("3 : You beat the dealer's ass\n")
	tie.buff_silence(0.5)
	tie.buff_text("4 (Pro poker player) : You know what to do since you counted the cards")
	tie.buff_silence(0.5)
...
func _on_Choice1_pressed():
	...
	if state == 2:
		get_tree().change_scene("res://gestion/ManagementScreen/EventScreen/Event3/Event3.tscn")
