...
func _ready():
	...
	tie.buff_text("You made a stop at Disneyland with your mates.\n", 0.03)
	tie.buff_silence(0.5)
	tie.buff_text("You're debatting about what to do.\n", 0.03)
	tie.buff_silence(0.5)
	tie.buff_text("What do you do ?\n\n\n\n")
	tie.buff_silence(0.5)
	tie.buff_text("1 : Space Mountain\n")
	tie.buff_silence(0.5)
	tie.buff_text("2 : Epcot\n")
	tie.buff_silence(0.5)
	tie.buff_text("3 : Magic Kingdom\n")
	tie.buff_silence(0.5)
	tie.buff_text("4 (Childish) : I WANT A PICTURE WITH MICKEY\n ")
	tie.buff_silence(0.5)
...
func _on_Choice1_pressed():
	if state < 2:
		tie.buff_clear()
		tie.buff_text("Space Mountain, good choice.\n", 0.03)
		tie.buff_text("You found 40 Neon after the ride\n", 0.03)
	...
	if state == 2:
		get_tree().change_scene("res://gestion/ManagementScreen/EventScreen/Event6/Event6.tscn")
...
func _on_Choice3_pressed():
	tie.buff_clear()
	tie.buff_text("YEAH MAGIC KINGDOM.\n", 0.03)
	tie.buff_silence(0.5)
	tie.buff_text("You found 30 Neon in the room.\n", 0.03)
